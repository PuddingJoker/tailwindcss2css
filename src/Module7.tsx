...
const ZktHeader = () => {
    return <div className="min-w-[1180px] relative h-[726px] hhhh ">
        {/* <Background src={floor4}></Background> */}
        <div className="w-[1180px] mx-auto relative pt-[80px] cccc">
            <div className="text-center tex-[#17181B] text-[26px] leading-[26px] aaaa">私域阵地经营</div>
